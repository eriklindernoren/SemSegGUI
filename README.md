...
+ segment.{hpp/cpp}     : Contains class representing an image segment. Keeps list of pixels and contour 
                          pixels that belonging to segment
...
+ segment.py            : Contains class representing an image segment. Keeps list of pixels and contour 
                          pixels that belonging to segment
